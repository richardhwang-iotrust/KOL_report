...
CHANNELS = [
    ...
    "WeCryptoTogether", "SUS_secretnote", "officialunivercityofcrypto", "jerryview", "JoshuaDeukKOR",
    "GODOGtrader", "Thoughts_BFox", "BChoSN", "icoroots", "dontak00",
    "enjoymyhobby", "crypto_fundraising", "murphybus", "fireantcrypto", "all_degens_are_dead",
    "marshallog", "Economicrypto", "dopaminemaxi", "lovejudylee", "c0wfarm",
    "mdewstable", "Raoni1", "theddari_main", "pannpunch", "waitstudy",
    "airdr0p_lab", "crypt0_sea", "justicekingsman", "tlsrltnf", "btc_alt_info",
    "blockmedia", "nftimagod", "mujammin123", "cryptopangpang", "dolchanchain",
    "dolbikong", "GMBLABS", "rolypopa", "yobeullyANN", "gensencoin",
    "Rowna999", "hanabicoin2", "killberosDAO", "allpointsaremine", "cobacknamannounce",
    "doratman18", "justdegenguy", "lnsanecoin", "narockisrock1", "MAC_DDDD",
    "dogeland01", "web3subin", "minebuu_cryptoball", "coinsaywhat", "Yndegen",
    ...
    "minchoisfuture", "dolgommagic", "yul_papa", "c4lvinlocked", "murphybus2",
    "pepe_fonji", "RezetAquatic", "yunlog_announcement", "notepad2124", "LEEHEESANGDYOR",
    "Sarangbang_Crypto", "ewlreads", "nojobnoplan", "catallactic", "cybertruck666",
    "easychartgo", "inhu0", "Hikicha0_0", "taste_suck", "money0stack9Notice",
    "homeworkgogo", "cryptoquant_kr", "Debt50mwon", "airdrop_kor", "Bananamilkrich",
    "BMTube", "forevernft", "Jobless_investor", "juhyukb", "sidejobvip",
    "moneygrid", "kimmm1kim", "coinboys", "BQTelegram", "jutrobedzielepsze",
    "inlyeog", "jammin0720", "namdongX", "moon252423", "Honeyofwhitesocks_2",
    "Jenti_DeFi", "quercus_0", "JUSTCRYT", "crypt0made", "vallettaidea",
    "KOREAalphaDEGEN", "shwhwgsicj", "coiniseasy", "pgyinfo", "anancoin",
    "centurywhale", "plusevdeal", "baborphantkr", "Capitalism_Academy", "kdp_dao",
    "btcbullforever", "havelaw", "SnowCrypto1", "cubestudy1557", "billair1",
    "alpha_duo", "popo5M", "RezetSide", "tangtangbox", "nethery2004",
    "FourPillarsFP", "Bounty_ATM", "soomoktube", "xvgwhitedog2", "ms0life",
    "myu_moonyu", "CoinWiki_MMWW", "eastsouthwind", "cctgavong", "vc_21m",
    "slav_insight", "tenaxcrypto", "pachepunch", "YAPHOPE", "dusrmsss",
    "cobak_alert", "Roh0517", "Board_the_Ark", "retrodao", "cryptocurrencymage",
    "PASACREW", "HeadingtoRome", "Ugh_HH", "look4treasure", "funkyonchain",
    "churin0329", "leo_autotrading", "cobling", "honey_drfox", "limelight_kor",
    "kkda8282", "karmycrypto", "gogangnam40", "Titanium_SPOON", "stay_news",
    "Katzenote", "honeymouse1003", "KryptoKlang", "Dynastylabs", "MingsBog",
    ...
    "yeolchoongNotice", "RWAkr", "jtakenotice1", "DannyCryptoWorld", "heunnnnnn",
    "zettgroup", "AlanInfoExchange", "R_0_D_0_L", "JOOONGDO", "kwakCrypto",
    "bestyeezus", "exilist_official", "xangle_research", "SOLful_hodl_life", "umjuninsight",
    "continuouslearningmatthew", "bnbchainkr", "shadow_investor_ann", "tiger_research", "rere2win",
    "jibegagosian", "airdropAScenter", "testnetduggang", "ModuDAO_ANN", "claireroom",
    "uksangtrashcan", "investmenttech", "darkpagu", "Jinstori", "legoleecm777",
    "mmormm123", "korea_crypto_official", "jesam84tele", "baroBTC", "jungculturalfind",
    "bulbul2cryptoDAO", "sonnicko", "eastgoonercrypto", "jason_nest", "AllroundResearchanCrypto",
    "kwondoll_2", "cblaboratory", "katimad", "wise_degen_house", "eksoo_announce",
    "realKoreanguy", "prediction_markets_info", "otakurypto", "dongmaryeo", "honeylab1",
    "sry_father", "HHBOX2", "blockschool", "getmoneywithbrother", "FackMeo",
    "goodkolb", "coinpharm", "coincodekr", "Info_Arbitrage", "coin369369",
    "bokjisaideashare", "imhedacool", "jayplaystudy", "RT7research", "cryptonote_kr",
    "DeSpread", "LovelyGaSaRi", "tokenview7", "sapiensidea", "crypto_class_ann",
    "nuttyflavors", "vistalabs", "mid_curve", "cryptonewsaggr", "edchart",
    "kbc80", "KORypto_Announce",
]
